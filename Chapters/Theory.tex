...
A \acf{pomdp} is a principled general framework capable of modeling a broad
range of sequential decision making problems under uncertainty. As the name
suggests, this problem class is a generalization of the more popular \ac{mdp}
