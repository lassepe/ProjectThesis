...
of \acf{mcts} with the idea of \acf{dpw} \cite{sunberg2018online}. As such,
\ac{pomcpow} utilizes \acf{mcts} to break the course of dimensionality
\cite{silver2010pomcp}.

In the following, we begin by briefly reviewing the general idea of \ac{mcts}.
This discussion seeks to provide insight into how this technique is adopted in
the context of \ac{pomcpow}. For a thorough discussion of a wide range of
\ac{mcts} algorithms, the reader may refer to \cite{browne2012survey}.
