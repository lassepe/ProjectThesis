...
\todo[inline]{Introduce notation used throughout the following text:}
\begin{itemize}
  \item history concatenation
  \item parameters / constants used
\end{itemize}
\todo[inline]{Maybe add a tabular overview for all variables.}
...
sample one of the previously sampled observations, $o \in C(ha)$.
