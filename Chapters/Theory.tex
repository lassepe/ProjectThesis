...
In fact, experiments that we ran to evaluate the runtime for one of the
problems studied in \cref{chap:hri} suggest that the highly optimized code
produced by the \emph{Julia} compiler may even outperform a naive \emph{C++}
implementation.\todo{point to appendix}
