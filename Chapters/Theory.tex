...
exploitation, the trade-of between looking at new parts of the state-action
space (widening the tree) and further exploring promising trajectories
(deepening the tree).

...
One iteration of the general \ac{mcts} approach is visualized in \cref{fig:mcts-general}.

\begin{figure}[htpb]
  \centering
  \includegraphics[width=0.8\linewidth]{mcts-general.png}
  \caption{One iteration of the general \ac{mcts} approach \cite{browne2012survey}.}
