...
the number of visits of node $h$; $M(h)$ is a count for the number of times the
observation terminated history $h$ has been generated. $B(h)$ represents a list
of states associated with node $h$, with $W(h)$ the corresponding weights.
