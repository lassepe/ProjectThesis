...
A statistical evaluation of these experiments is depicted in
\cref{fig:lp-evaluation}. The first row shows the \ac{sem} of the cumulative
discounted reward over the $1000$ experiments for each policy. The second
row...
