...
problem and motion planning is performed on expectation. That is\todo[author=ZS]{"That is" isn't normally used to start a sentence}, trajectories
...
higher statistical moments \todo{What is the right word for this?}\todo{maybe "higher entropy"} may be used
...
\begin{description}
  \item[Analytic Bounds] In this strategy we compute the bounds using an
      analytic, closed form\todo{what is a better phrasing for this?}/todo{seems ok to me}
    ...
    under-approximation on the velocity to obtain $n_{\text{max}}$\todo[author=ZS]{Wow, this seems like a really poor bound; it's very interesting to know that it works.}. In either
