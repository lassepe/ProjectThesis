...
\begin{description}
  ...
  \item[Reward Function $\reward: \sspace \times \aspace \times
    ...
    if the denoted condition is met \todo{use correct symbol and better
    explanation}. The reward model is parametrized by the following quantities:
