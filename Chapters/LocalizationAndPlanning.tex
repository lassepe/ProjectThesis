...
problem and motion planning is performed on expectation. That is\todo[author=ZS]{"That is" isn't normally used to start a sentence}, trajectories\todo[author=LP]{Stephen Hawking does use it this way.}
